...
template <typename T>
vhuk::FrankList<T>::FrankList(size_type size, const_reference init) : vhuk::FrankList<T>::FrankList() {
...
template <typename T>
vhuk::FrankList<T>::FrankList(const FrankList<value_type>& rhv) : vhuk::FrankList<T>::FrankList() 
{
	for(reverse_iterator it = rhv.begin(); it != rhv.end(); ++it){
		push_back(*it);
	} 
}
...
template <typename T>
vhuk::FrankList<T>::FrankList(FrankList<value_type>&& rhv) : head(rhv.head), tail(rhv.tail), ahead(rhv.ahead), atail(rhv.atail) 
{
	rhv.head = nullptr;
	rhv.tail = nullptr;
	rhv.ahead = nullptr;
...
template <typename T>
vhuk::FrankList<T>::FrankList(std::initializer_list<value_type> init) : vhuk::FrankList<T>::FrankList() {
...
vhuk::FrankList<T>::FrankList(input_iterator f, input_iterator l) : vhuk::FrankList<T>::FrankList()
{
...
void vhuk::FrankList<T>::print(bool sorted, bool reversed){
	...
	if (!sorted && !reversed){
		...
		for (reverse_iterator it = rbegin(); it != rand(); ++it){
			std::cout << *it << " ";
		}
	} else if (!reversed){
		for (asc_iterator it = abegin(); it != aend(); ++it){
			std::cout << *it << " ";
		}
	} else {
		for (desc_iterator it = dbegin(); it != dend(); ++it){
			std::cout << *it << " ";
		}
	}
	std::cout << " ]~";
...
void vhuk::FrankList<T>::organize_left(Node* ptr){
	if(ptr == nullptr || ptr == head){ return; }
		Node* prev = ptr->prev;
		Node* next = ptr->next;
		if (prev){
			if(prev->prev){
...
template <typename T>
 void vhuk::FrankList<T>::organize_right(Node* ptr){
	if(ptr == nullptr || ptr == tail){ return; }
	Node* prev = ptr->prev;
	Node* next = ptr->next;
	if (prev){
		if(next->next){
...
template <typename T>
vhuk::FrankList<T>::const_iterator::const_iterator(base_iterator&& rhv) : base_iterator(rhv.ptr){
	if(rhv.ptr == this->ptr){
		return ;
	}
	rhv.ptr = nullptr;
...
// postfix ++ 
template <typename T>
const  typename vhuk::FrankList<T>::const_iterator vhuk::FrankList<T>::const_iterator::operator++(int) {
...
// iterator
template <typename T>
vhuk::FrankList<T>::iterator::iterator(const base_iterator& rhv) : const_iterator(rhv.ptr) {}

template <typename T>
const typename vhuk::FrankList<T>::iterator& vhuk::FrankList<T>::iterator::operator=(const base_iterator& rhv) {
    const_iterator::operator=(rhv.ptr);
    return *this;
}
...
// muv assign
template <typename T>
const typename vhuk::FrankList<T>::iterator::iterator& vhuk::FrankList<T>::iterator::operator=(base_iterator&& rhv){
	const_iterator::operator=(rhv.ptr);
	rhv.ptr = nullptr;
	return *this;
}
...
//const revers iterator
template <typename T>
vhuk::FrankList<T>::const_reverse_iterator::const_reverse_iterator(const base_iterator& rhv) : base_iterator(rhv.ptr){}


template <typename T>
vhuk::FrankList<T>::const_reverse_iterator::const_reverse_iterator(base_iterator&& rhv): base_iterator(rhv.ptr) { 
	rhv.ptr = nullptr;
}
...
//	base_iterator::operator=(rhv.ptr);
	this->ptr = rhv.ptr;
	return this;
}
...
template <typename T>
vhuk::FrankList<T>::reverse_iterator::reverse_iterator(base_iterator&& rhv) : const_reverse_iterator(rhv.ptr){
	rhv.ptr = nullptr;
}
...
template <typename T>
vhuk::FrankList<T>::const_asc_iterator::const_asc_iterator(base_iterator&& rhv):base_iterator(rhv.ptr){
	rhv.ptr = nullptr;
}
...
template <typename T>
const typename vhuk::FrankList<T>::const_asc_iterator vhuk::FrankList<T>::const_asc_iterator::operator++(int){
	base_iterator tmp = this->ptr;
	this->ptr = this->ptr->asc;
	return tmp;
}
...
template <typename T>
vhuk::FrankList<T>::asc_iterator::asc_iterator(Node* ptr) : base_iterator(ptr){}
...
template <typename T>
const typename vhuk::FrankList<T>::const_desc_iterator vhuk::FrankList<T>::const_desc_iterator::operator++(int){
	base_iterator tmp = this->ptr;
	this->ptr = this->ptr->desc;
	return tmp;
}
...
template <typename T>
vhuk::FrankList<T>::desc_iterator::desc_iterator(Node* ptr) : base_iterator(ptr){}


//multi const iterator
template <typename T>
vhuk::FrankList<T>::const_multi_iterator::const_multi_iterator(const base_iterator& rhv) :base_iterator(rhv.ptr){}

template <typename T>
vhuk::FrankList<T>::const_multi_iterator::const_multi_iterator(base_iterator&& rhv) :base_iterator(rhv.ptr){
	rhv.ptr = nullptr;
}
...
template <typename T>
vhuk::FrankList<T>::multi_iterator::multi_iterator(base_iterator&& rhv) : const_multi_iterator(rhv.ptr){
	rhv.ptr = nullptr;
}
